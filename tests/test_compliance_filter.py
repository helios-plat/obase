...
def _make_filter() -> NotificationComplianceFilter:
    ...
    f.register_quiet_hours(
        start_time=time(22, 0), end_time=time(7, 0), timezone="Asia/Shanghai", scope="non_critical"
    )
    f.register_disclaimer_template(
...
class TestNotificationComplianceFilter:
    def test_quiet_hours_blocks_non_critical(self) -> None:
        ...
        msg = {
            ...
            "severity": "info",
            "content": "Test",
            "timestamp": datetime(2026, 5, 23, 23, 30, tzinfo=ZoneInfo("Asia/Shanghai")),
        }
    ...
    def test_disclaimer_template_injected(self) -> None:
        ...
        msg = {
            ...
            "severity": "info",
            "content": "茅台涨停",
            "timestamp": datetime(2026, 5, 23, 10, 0, tzinfo=ZoneInfo("Asia/Shanghai")),
        }
        result = f.filter(msg)
        assert result is not None
    ...
    def test_timezone_cross_midnight(self) -> None:
        ...
        msg = {
            ...
            "severity": "info",
            "content": "Early",
            "timestamp": datetime(2026, 5, 24, 6, 30, tzinfo=ZoneInfo("Asia/Shanghai")),
        }
        assert f.filter(msg) is None
        ...
        msg2 = {
            ...
            "severity": "info",
            "content": "Morning",
            "timestamp": datetime(2026, 5, 24, 8, 0, tzinfo=ZoneInfo("Asia/Shanghai")),
        }
    ...
    def test_quiet_end_before_start_same_day(self) -> None:
        ...
        f = NotificationComplianceFilter()
        f.register_quiet_hours(
            start_time=time(23, 0), end_time=time(5, 0), timezone="UTC", scope="non_critical"
        )
        ...
        msg = {
            ...
            "severity": "info",
            "content": "Y",
            "timestamp": datetime(2026, 5, 24, 0, 30, tzinfo=ZoneInfo("UTC")),
        }
        assert f.filter(msg) is None
        # 12:00 UTC = outside
        msg2 = {
            ...
            "severity": "info",
            "content": "Y",
            "timestamp": datetime(2026, 5, 24, 12, 0, tzinfo=ZoneInfo("UTC")),
        }
        assert f.filter(msg2) is not None
    ...
    def test_combined_quiet_and_keyword(self) -> None:
        ...
        msg = {
            ...
            "timestamp": datetime(2026, 5, 24, 10, 0, tzinfo=ZoneInfo("Asia/Shanghai")),
        }
        assert f.filter(msg) is None
